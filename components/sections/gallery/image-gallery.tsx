...
const ImageGallery = () => {
  ...
  return (
    <div className="max-w-screen  relative h-[120vh] overflow-hidden md:h-[150vh]">
      <section className=" absolute left-1/2 top-0 grid h-[120vh] w-[190vw] -translate-x-1/2 transform grid-cols-3 gap-[15px] overflow-hidden bg-softBlack sm:w-[160vw] md:h-[150vh] md:w-[140vw] md:gap-3">
